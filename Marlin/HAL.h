...
// **************************************************************************
  ...
  #define REFERENCE_EXTRUDER_TIMER_FREQUENCY (HAL_REFERENCE_EXTRUDER_TIMER_RATE / 200) // 1.25KHz at start // note: timer0 is in mode3?
  ...
  #define REFERENCE_STEPPER_TIMER_FREQUENCY (HAL_REFERENCE_STEPPER_TIMER_RATE / 2000) // 1KHz at start
