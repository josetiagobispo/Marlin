...
#define CUSTOM_MACHINE_NAME "UM v2.4 ported"
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 200 // original is 160
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode.
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 5 // original is ACCURATE_BED_LEVELING_POINTS 3
...
#define DEFAULT_XYJERK                10.0    // (mm/sec) // original is 20.0
#define DEFAULT_ZJERK                 10.0    // (mm/sec) Must be same as XY for delta // original is 20.0
#define DEFAULT_EJERK                 2.5     // (mm/sec) // original is 20.0
