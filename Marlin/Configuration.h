...
#define STRING_CONFIG_H_AUTHOR "(MICROMAKE KOSSEL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UM v2.4"
...
#define EXTRUDE_MINTEMP 0 // for extruder test
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 120 // original is 160
  ...
  #define DELTA_PRINTABLE_RADIUS 75 // original is 100
...
const bool X_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. // original is false
const bool Y_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. // original is false
const bool Z_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. // original is false
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode.
    ...
    #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 25) // original is (DELTA_PRINTABLE_RADIUS - 50)
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 7 // original is ACCURATE_BED_LEVELING_POINTS 3
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0   // Z offset: -front [of the nozzle] +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.5 // Z offset: -below [the nozzle] (always negative!)

<<<<<<< HEAD
  #define Z_RAISE_BEFORE_HOMING 0       // (in mm) Raise Z axis before homing (G28) for Z probe clearance. // original is 4
                                        // Be sure you have this distance over your Z_MAX_POS in case.

  #define XY_TRAVEL_SPEED 3000         // X and Y axis travel speed between probes, in mm/min.
=======
  #define XY_TRAVEL_SPEED 8000         // X and Y axis travel speed between probes, in mm/min.
>>>>>>> refs/remotes/origin/RCBugFix
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 338 // For delta: Distance between nozzle and print surface after homing. //original is 200//306.6
#endif
...
#define XYZ_STEPS (double(XYZ_FULL_STEPS_PER_ROTATION) * double(XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 476.55 * (XYZ_MICROSTEPS / 16)}
...
#define DEFAULT_XYJERK                20.0    // (mm/sec) // original is 20.0
#define DEFAULT_ZJERK                 20.0    // (mm/sec) Must be same as XY for delta // original is 20.0
#define DEFAULT_EJERK                 5.0     // (mm/sec) // original is 20.0
